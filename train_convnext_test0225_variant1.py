...
EFFECTIVE_BATCH_SIZE = BATCH_SIZE * GRADIENT_ACCUMULATION_STEPS  # 有效batch size = 32
    ...
    if MODEL_TYPE == "VisualFlowEncoder":
        ...
        student = PureConvNext3DModel(latent_channels=2048, output_channels=1536, num_frames=NUM_FRAMES,
                                      encoder_dims=[96, 192, 384, 768, 1024, 1536],
                                        encoder_depths=[3, 3, 12, 3, 2, 2],
                                        decoder_dims=[1536, 1024, 768],
                                        decoder_depths=[1, 2, 4],)
