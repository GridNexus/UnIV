...
SWANLAB_RUN_NAME = f"dinov3_siglip2_stvit_RMSNorm"
...
MODEL_TYPE = "SpatialTemporalEncoder"
RANDOM_SEED = 0
...
def main():
    ...
    teachers = TeacherEnsemble(DINOV3_PATH, SIGLIP2_PATH, "rmsnorm").to(device).to(torch.bfloat16)
    teachers.eval()
