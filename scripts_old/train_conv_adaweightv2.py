...
from lib.loss import DecoupledDistillationLoss, AdaptiveDecoupledDistillationLoss, AdaptiveWeightedLossV2
...
SWANLAB_RUN_NAME = f"conv_loss_adav2"
...
def main():
    ...
    # loss_fn = AdaptiveDecoupledDistillationLoss(
    #     loss_types=LOSS_TYPE,
    #     split_dim=768,
    #     channel_dim=2
    # ).to(device)

    loss_fn = AdaptiveWeightedLossV2(
        loss_types=LOSS_TYPE,
        split_dim=768,
        channel_dim=2
    ).to(device)
