...
from lib.student_modeling_v3 import SpatiotemporalFeatureEncoderV3
from lib.student_modeling_v4 import ChronosNexusV1
...
SWANLAB_RUN_NAME = f"structure_chronV1_smaller"
...
def main():
    ...
    elif MODEL_TYPE == "SpatiotemporalFeatureEncoder":
    ...
    elif MODEL_TYPE == "SpatiotemporalFeatureEncoderV3":
        student = SpatiotemporalFeatureEncoderV3(latent_channels=2048, output_channels=1536, num_frames=NUM_FRAMES)
    elif MODEL_TYPE == "ChronosNexusV1":
        student = ChronosNexusV1(latent_channels=2048, output_channels=1536, num_frames=NUM_FRAMES)
